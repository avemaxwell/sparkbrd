...
const FONT_OPTIONS: FontOption[] = [
  ...
  { id: "updock",              label: "Updock",              fontFamily: "var(--font-updock)",              fontWeight: "400", fontSize: "1.2rem" },
  { id: "cabin-sketch",        label: "Cabin Sketch",        fontFamily: "var(--font-cabin-sketch)",        fontWeight: "400", fontSize: "1.05rem" },
  { id: "splash",              label: "Splash",              fontFamily: "var(--font-splash)",              fontWeight: "400", fontSize: "1.3rem" },
  { id: "sedgwick",            label: "Sedgwick Ave",        fontFamily: "var(--font-sedgwick)",            fontWeight: "400", fontSize: "1.15rem" },
  { id: "unkempt",             label: "Unkempt",             fontFamily: "var(--font-unkempt)",             fontWeight: "400", fontSize: "1.05rem" },
  { id: "love-ya",             label: "Love Ya Like A Sister", fontFamily: "var(--font-love-ya)",           fontWeight: "400", fontSize: "1rem" },
  { id: "engelbert",           label: "Engelbert",           fontFamily: "var(--font-engelbert)",           fontWeight: "400", fontSize: "1.05rem" },
  { id: "kablammo",            label: "Kablammo",            fontFamily: "var(--font-kablammo)",            fontWeight: "400", fontSize: "1.15rem" },
  { id: "pacifico",            label: "Pacifico",            fontFamily: "var(--font-pacifico)",            fontWeight: "400", fontSize: "1.1rem" },
  { id: "satisfy",             label: "Satisfy",             fontFamily: "var(--font-satisfy)",             fontWeight: "400", fontSize: "1.2rem" },
  { id: "lobster",             label: "Lobster",             fontFamily: "var(--font-lobster)",             fontWeight: "400", fontSize: "1.15rem" },
  { id: "bangers",             label: "Bangers",             fontFamily: "var(--font-bangers)",             fontWeight: "400", fontSize: "1.3rem", letterSpacing: "0.05em" },
  { id: "permanent-marker",    label: "Permanent Marker",    fontFamily: "var(--font-permanent-marker)",    fontWeight: "400", fontSize: "1.05rem" },
  { id: "architects-daughter", label: "Architects Daughter", fontFamily: "var(--font-architects-daughter)", fontWeight: "400", fontSize: "1rem" },
  { id: "indie-flower",        label: "Indie Flower",        fontFamily: "var(--font-indie-flower)",        fontWeight: "400", fontSize: "1.05rem" },
  { id: "righteous",           label: "Righteous",           fontFamily: "var(--font-righteous)",           fontWeight: "400", fontSize: "1.05rem" },
  { id: "monoton",             label: "Monoton",             fontFamily: "var(--font-monoton)",             fontWeight: "400", fontSize: "1rem",   letterSpacing: "0.05em" },
  { id: "fjalla",              label: "Fjalla One",          fontFamily: "var(--font-fjalla)",              fontWeight: "400", fontSize: "1.1rem" },
  { id: "yeseva",              label: "Yeseva One",          fontFamily: "var(--font-yeseva)",              fontWeight: "400", fontSize: "1.15rem" },
  { id: "playfair",            label: "Playfair Display",    fontFamily: "var(--font-playfair)",            fontWeight: "400", fontSize: "1.05rem" },
];
...
const FONT_FAMILY_MAP: Record<string, string> = {
  ...
  "cabin-sketch":         "var(--font-cabin-sketch)",
  splash:                 "var(--font-splash)",
  sedgwick:               "var(--font-sedgwick)",
  unkempt:                "var(--font-unkempt)",
  "love-ya":              "var(--font-love-ya)",
  engelbert:              "var(--font-engelbert)",
...
const handleTextRotateEnd = async () => {
  ...
  const addTextBlock = async (content: string, fontStyle: string, overrideColor?: string) => {
    ...
    const fontSizeMap: Record<string, number> = {
      ...
      updock: 28, "cabin-sketch": 22, splash: 32, sedgwick: 26,
      unkempt: 22, "love-ya": 20, engelbert: 20, kablammo: 28,
      pacifico: 26, satisfy: 28, lobster: 28, bangers: 32,
      "permanent-marker": 22, "architects-daughter": 20, "indie-flower": 20,
      righteous: 22, monoton: 20, fjalla: 22, yeseva: 28, playfair: 22,
    };
