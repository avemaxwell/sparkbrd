        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {SIGNALS.map((s, i) => (
            <Reveal key={s.text} delay={i * 60}>
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-black/5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 h-full">
