  ...
  return (
    <section className="relative overflow-hidden bg-papaya py-20 md:py-28 px-6">
      <div className="absolute -top-16 -right-10 animate-float-slow">
        <Blob className="w-56 h-56 bg-white/10 pointer-events-none" />
      </div>
      <div className="absolute bottom-4 left-4 hidden lg:block animate-float-slow [animation-delay:1s]">
        <PatternCornerAlt />
      </div>
      ...
      <Reveal className="relative max-w-3xl mx-auto text-center">
        ...
        <a
          href="/labs"
          className="inline-flex items-center gap-2 mt-9 px-8 py-4 bg-lime text-ink text-sm font-semibold rounded-full hover:bg-lime/90 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
        >
          Explore Labs
