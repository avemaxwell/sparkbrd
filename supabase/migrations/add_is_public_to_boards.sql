...
DROP POLICY IF EXISTS "Public tacks are readable by anyone" ON tacks;
CREATE POLICY "Public tacks are readable by anyone"
  ON tacks FOR SELECT
  USING (
    EXISTS (
...
DROP POLICY IF EXISTS "Public boards are readable by anyone" ON boards;
