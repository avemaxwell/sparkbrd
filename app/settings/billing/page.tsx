    ...
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {/* Free Plan */}
          <div className={`relative border-2 rounded-2xl p-8 ${
            currentPlan === 'free' ? 'border-papaya bg-papaya/5' : 'border-ink/10 bg-white'
          }`}>
            <div className="mb-6">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-ink/70">Basic backgrounds</span>
              </li>
            </ul>
          ...
          {/* Pro Plan */}
          <div className={`relative border-2 rounded-2xl p-8 ${
            currentPlan === 'pro' ? 'border-papaya bg-papaya/5' : 'border-ink/10 bg-white'
          }`}>
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <span className="px-4 py-1 bg-papaya text-white text-xs font-semibold rounded-full">
                Popular
              </span>
            </div>
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-ink/70">200 tacks per board</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">Custom colors</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">No branding</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">Export boards</span>
              </li>
            </ul>
          ...
          {/* Team Plan */}
          <div className={`relative border-2 rounded-2xl p-8 ${
            currentPlan === 'team' ? 'border-papaya bg-papaya/5' : 'border-ink/10 bg-white'
          }`}>
            <div className="mb-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-ink/70">Everything in Pro</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">Unlimited tacks</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">Real-time collaboration</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 stroke-green-600 stroke-2 fill-none flex-shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                <span className="text-ink/70">Team workspace</span>
              </li>
            </ul>
